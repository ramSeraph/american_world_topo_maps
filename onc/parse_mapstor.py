...
class ONCMapstorProcessor(TopoMapProcessor):

    def __init__(self, filepath, extra, index_box, index_properties, projinfo=None):
...
def get_bad_sheet_ids():
    with open('mapstor/bad_sheets.txt', 'r') as f:
...
def process_files():
    ...
    for filepath in image_files:
        ...
        processor = ONCMapstorProcessor(filepath, extra, [], sheet_props, projinfo)
